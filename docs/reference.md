...
| `panel-anilist.html`      | `baseof.html`                                           | `otaku.sh` — two AniList strips: `#last-read-manga` (`$ anilist manga --status=reading`) and `#last-watched-anime` (`$ anilist anime --status=watching`), separated by `.panel-terminal-gap`; both filled by one request from `anilist.js` |
...
| `anilist.js`          | `cache.js` | `#last-read-manga`, `#last-watched-anime`                                                                 | AniList GraphQL                                    | `anilist-<user>-current-<limit>`                              | One aliased GraphQL query (`manga` + `anime` `MediaListCollection`, status CURRENT, sort UPDATED_TIME_DESC) for user "finer"; each strip renders up to `ANILIST_LIMIT` covers, `$ nothing in progress` when a list is empty; renders AniList `countryOfOrigin` as uppercase primary-color cover stamps (`.manga-origin`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `anilist-<username>-current-<limit>` | `anilist.js`       | Combined manga + anime "current" list response payload                                         |
