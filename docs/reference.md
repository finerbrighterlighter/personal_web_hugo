...
|---|---|---|
| API responses (OpenAlex, Last.fm, AniList, Unsplash, BibTeX) and the build-time `screen.sh` blob (`simkl.js`) | `cache.js` via `setCache()` | Yes — triggers full reset |
