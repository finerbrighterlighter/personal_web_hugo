...
| `trakt.js`            | `cache.js` | `#last-watched`                                                                                           | Trakt + TMDB APIs                                  | `trakt-watched`                                               | Recently watched; dedupes consecutive repeats; TMDB poster images plus `original_language` uppercase primary-color cover stamps (`.screen-language`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
