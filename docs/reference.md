...
| `anilist.js`          | `cache.js` | `#last-read-manga`, `#last-watched-anime`                                                                 | AniList GraphQL                                    | `anilist-<user>-recent-<limit>`                              | One aliased GraphQL query (`manga` + `anime` `Page.mediaList`, `status_not: PLANNING`, sort UPDATED_TIME_DESC, `perPage = ANILIST_LIMIT`) for user "finer" — most recently updated entries regardless of watching/reading/finished/dropped/paused; hover title appends the status label; `$ no recent activity` when a list is empty; renders AniList `countryOfOrigin` as uppercase primary-color cover stamps (`.manga-origin`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
